/*-- $Id: MIFDocWriter.java,v 1.1.1.1 2003/12/24 12:38:12 kshaikh Exp $ --*/
 ...
 */
public class MIFDocWriter extends PDFDocWriter {
	...
	public void writeDoc() throws Exception {
		log.info("Creating MIF output ..");
		writeDocUsingFOP(Driver.RENDER_MIF);
	}
}
